...
import (
	...
	rpccore "github.com/tendermint/classic/rpc/core"
	ctypes "github.com/tendermint/classic/rpc/core/types"
	grpccore "github.com/tendermint/classic/rpc/grpc"
	...
	"github.com/tendermint/classic/state/txindex/kv"
	"github.com/tendermint/classic/state/txindex/null"
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewPEXReactor(addrBook,
		&pex.PEXReactorConfig{
			...
			// https://github.com/tendermint/classic/issues/3523
...
func NewNode(config *cfg.Config,
	...
	if pubKey == nil {
		// TODO: GetPubKey should return errors - https://github.com/tendermint/classic/issues/3602
