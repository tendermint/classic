...
// https://godoc.org/github.com/tendermint/classic/types#pkg-constants
//
// For complete query syntax, check out
// https://godoc.org/github.com/tendermint/classic/libs/pubsub/query.
//
// ```go
// import "github.com/tendermint/classic/types"
//
