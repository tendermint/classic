...
func TestTickPassedDepositPeriod(t *testing.T) {
	...
	input.keeper.cdc.MustUnmarshalLengthPrefixed(res.Data, &proposalID)
...
func TestTickPassedVotingPeriod(t *testing.T) {
	...
	require.NoError(t, input.keeper.cdc.UnmarshalLengthPrefixed(activeQueue.Value(), &activeProposalID))
